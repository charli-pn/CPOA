...
<div class="container text-center">
	...
	<h4 class="center">Choisissez le match</h4>
	...
	<?php
		foreach($affichage as $match){?>
			<tr>
				...
				?></td>
				<td class="right"><a class="btn-floating btn-medium waves-effect waves-light teal" href="index.php?page=nbplacescateg2&id=<?=$match['idMatch']?>"><i class="material-icons">arrow_forward</i></a></td>
			</tr>
	<?php
		}
	?>
